                ...
                <a :href="photo.links.download" target="_blank">
                    ...
                    <div
                        ...
                        <div class="w-full flex flex-row items-center justify-between px-4 py-1 ">
                            ...
                            <div class="flex flex-row items-center">
                                <svg class="h-4" viewBox="15.257 71.064 36 31.091" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M48.679 73.672c-3.438 -3.478 -9.169 -3.478 -12.771 0l-2.619 2.65 -2.619 -2.651c-3.438 -3.476 -9.169 -3.476 -12.771 0 -3.604 3.479 -3.44 9.275 0 12.917l15.39 15.566 15.39 -15.566a9.378 9.378 0 0 0 0 -12.915"
